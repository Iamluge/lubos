...
import com.lu.bos.dao.base.INoticebillDao;
import com.lu.bos.dao.base.IWorkbillDao;
...
import com.lu.bos.domain.Workbill;
...
public class NoticebillServiceImpl implements INoticebillService {
	...
	public void save(Noticebill model) {
		...
		//TODO 后期需要完善的地方
		try {
			decidedzoneId = customerService.findDecidedzoneIdByAddress(pickaddress);
		} catch (Exception e) {
			System.out.println("这个错误有点问题下次在解决");
		}
