...
public class StaffAction extends BaseAction<Staff> {
	...
	public String listajax(){
		List< Staff> lsit=staffService.findListNotDelete();
		this.java2Json(lsit, new String[]{"telephone","haspda","decidedzones","standard","station","deltag"});
		return NONE;
	}
